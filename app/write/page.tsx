    ...
    <div className="min-h-screen bg-[#f8f9fa] text-neutral-900 antialiased">
      ...
      <main className="mx-auto w-full max-w-3xl px-4 py-10">
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm leading-6 text-neutral-600">간단한 기사글을 작성할 수 있는 공간입니다. 여러 장의 사진을 활용하거나 보다 체계적인 편집이 필요한 기사글은 <a href="http://huss.harmonynet.kr/wp-admin" target="_blank" rel="noopener noreferrer" className="font-semibold text-red-700 hover:underline">하모니넷 편집자 페이지</a>에 로그인한 후 작성해 주세요.</p>
        </div>
